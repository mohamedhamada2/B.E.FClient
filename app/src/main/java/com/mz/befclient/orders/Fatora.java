...
public class Fatora {
    ...
    @Expose
    private String paid;
    @SerializedName("discount_nesba")
    @Expose
    private String discountNesba;
    ...
    public String getDiscountNesba() {
        return discountNesba;
    }

    public void setDiscountNesba(String discountNesba) {
        this.discountNesba = discountNesba;
    }
