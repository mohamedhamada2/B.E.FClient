...
//                                    sb.append(addresses.get(0).getCountryName());
                                    ...
                                    if (flag == 1){
                                        ...
                                        if (userModel.getData().getLatitude() != null || userModel.getData().getLongitude() != null){
                                            lat = Double.parseDouble(userModel.getData().getLatitude());
                                            lon = Double.parseDouble(userModel.getData().getLongitude());
